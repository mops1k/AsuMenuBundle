...
```php
<?php
namespace Asu\EditorumBundle\Menu\Builder;

use Asu\MenuBundle\Model\BuilderInterface;
use Asu\MenuBundle\Model\Common\AbstractBuilder;
...
```php
<?php
namespace Asu\EditorumBundle\Menu;

use Asu\EditorumBundle\Menu\Builder\MainBuilder;
use Asu\MenuBundle\Model\Common\AbstractMenu;
...
services:
    asu.menu.global:
        class: Asu\EditorumBundle\Menu\MainMenu
        parent: asu.menu.base_menu
        tags:
            - { name: asu_menu, alias: global }

    asu.builder.global:
        class: Asu\EditorumBundle\Menu\Builder\MainBuilder
        arguments:
            - '@translator'
        tags:
